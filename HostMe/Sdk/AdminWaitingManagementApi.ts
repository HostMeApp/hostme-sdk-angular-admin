...
namespace HostMe.Sdk {
    ...
    export class AdminWaitingManagementApi {
         ...
         * @param conf 
         */
        public addConfirmedWaiting (restaurantId: number, conf: PanelConfirmation, extraHttpRequestParams?: any ) : ng.IHttpPromise<WaitingItem> {
         ...
         */
        public confirm (restaurantId: number, waitingItemId: number, conf: PanelConfirmation, extraHttpRequestParams?: any ) : ng.IHttpPromise<WaitingItem> {
         ...
         */
        public sendMessage (restaurantId: number, waitingItemId: number, origin: string, createMessage: CreateMessage, extraHttpRequestParams?: any ) : ng.IHttpPromise<Message> {
         ...
         */
        public updateWaiting (restaurantId: number, waitingItemId: number, item: UpdateWaitingItem, extraHttpRequestParams?: any ) : ng.IHttpPromise<WaitingItem> {
            const localVarPath = this.basePath + '/api/wm/admin/restaurant/{restaurantId}/waitings/{waitingItemId}'
                .replace('{' + 'restaurantId' + '}', String(restaurantId))
                .replace('{' + 'waitingItemId' + '}', String(waitingItemId));
