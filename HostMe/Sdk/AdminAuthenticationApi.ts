...
namespace HostMe.Sdk {
    ...
    export class AdminAuthenticationApi {
         ...
         * @param generateState 
         */
        public getExternalLogins (returnUrl: string, generateState?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<ExternalLogin>> {
